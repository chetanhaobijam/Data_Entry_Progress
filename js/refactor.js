...
const showTotalProgress = () => {
  ...
  removeActiveData();
  progress(724, 377, em, 2807, 1763, em, 12192, 1545, em, 11426, 1334, em, 8513, 1277, em);
}
...
may22.addEventListener("click", () => {
  ...
  removeActiveData();
  progress(0, 154, em, 2, 515, em, 1990, 613, em, 2863, 509, em, 2545, 449, em);
})
...
june22.addEventListener("click", () => {
  ...
  removeActiveData();
  progress(0, 0, em, 0, 0, em, 1639, 0, em, 1716, 118, em, 1973, 31, em);
})
...
twoJune22.addEventListener("click", () => {
  progress(0, 0, other, 0, 0, `${excel} & ${print}`, 502, 0, em, 360, 0, em, 440, 0, em);
})

// Function to display the stats for 03 June 22
threeJune22.addEventListener("click", () => {
  progress(0, 0, other, 0, 0, `${excel}, ${print} & ${make}`, 554, 0, em, 346, 0, em, 300, 0, em);
})

// Function to display the stats for 04 June 22
fourJune22.addEventListener("click", () => {
  progress(0, 0, abs, 0, 0, `${excel}, ${print} & Gazette Title Correction`, 0, 0, `Gazette Title Correction`, 186, 0, em, 172, 0, em);
})

// Function to display the stats for 06 June 22
sixJune22.addEventListener("click", () => {
  progress(0, 0, other, 0, 0, `${excel} & ${make}`, 81, 0, `${make}, Scanning Completed`, 396, 0, `Scanning Completed`, 380, 0, em);
})

// Function to display the stats for 07 June 22
sevenJune22.addEventListener("click", () => {
  progress(0, 0, other, 0, 0, `${excel} & ${make}`, 0, 0, make, 0, 52, `Entry Started`, 344, 0, em);
})

// Function to display the stats for 08 June 22
eightJune22.addEventListener("click", () => {
  progress(0, 0, other, 0, 0, `${excel} & ${make}`, 0, 0, make, 0, 66, em, 93, 31, `Scanning Completed, Entry Started`);
})
